...
public class Regex_Checker {
	public static boolean Mobile_Number_Verifier(String number){
	...
	public static boolean Telephone_Number_Verifier(String number) {
	...
	public static boolean Email_Verifier(String mail) {
